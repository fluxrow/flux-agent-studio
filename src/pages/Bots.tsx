...
export default function Bots() {
  ...
  const { data, isLoading } = useBots({ search: q });
    ...
    <div className="p-6 lg:p-8 space-y-6 max-w-[1600px] mx-auto">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Crie seu primeiro agente conversacional para começar."
          action={
            <Link to="/bots/new">
              ...
              <div className="relative">
                ...
                <div className="mt-5 grid grid-cols-2 gap-3 pt-4 border-t border-border">
                  <div>
                    ...
                    <div className="font-display text-xl font-bold mt-0.5">{b.metrics.conversations.toLocaleString()}</div>
                  </div>
                  <div>
                    <div className="text-[10px] uppercase tracking-wider text-muted-foreground">Conversões</div>
                    <div className="font-display text-xl font-bold mt-0.5 text-success">{b.metrics.conversions.toLocaleString()}</div>
                  </div>
                </div>
